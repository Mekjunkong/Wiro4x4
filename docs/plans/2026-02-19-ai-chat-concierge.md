...
export async function handleChatMessage(
  ...
  if (msg.type === "message") {
    ...
    try {
      ...
      const fallback =
        language === "he"
          ? "מצטער, נתקלתי בבעיה. אפשר לפנות אלינו ישירות בוואטסאפ: +66816401397"
          : "Sorry, I encountered an issue. You can reach us on WhatsApp: +66816401397";
    ...
    ws.onmessage = event => {
      ...
      switch (data.type) {
        ...
        case "handoff_initiated":
          ...
          window.open(
            `https://wa.me/66816401397?text=${whatsappMsg}`,
            "_blank"
          );
          break;
