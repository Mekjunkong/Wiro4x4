...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pb-32 md:pb-20">
      ...
      {/* Content */}
      <div className="container relative z-10 text-center text-white py-32 pb-56 md:pb-40">
