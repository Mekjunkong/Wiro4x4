  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main id="main-content" className="flex-1">
        {/* Hero section */}
        <section className="bg-gradient-to-b from-[#faf7f2] to-white dark:from-[#1a1a1a] dark:to-[#242424] pt-36 pb-8">
          <div className="container mx-auto px-4 md:px-6 lg:px-8">
            <Breadcrumb items={[{ label: t("One-Day Tours", "טיולי יום") }]} />
            <Link
              href="/"
              className="inline-flex items-center gap-1 text-sm text-[#d4af37] hover:underline mt-2 mb-4"
            >
              <ArrowLeft className="w-3.5 h-3.5" />
              {t("All Adventures", "כל ההרפתקאות")}
            </Link>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-[#1c1c1c] dark:text-white">
              {t("One-Day Adventures", "טיולי יום")}
            </h1>
            <p className="text-[#1c1c1c]/60 dark:text-white/60 mt-3 max-w-2xl text-lg">
              {t(
