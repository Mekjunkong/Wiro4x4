...
const FALLBACK_PACKAGES: Record<string, FallbackPackage> = {
  "northern-thailand-3d2n": {
    ...
    description:
      "An unforgettable 3-day off-road adventure through the mountains of Northern Thailand. Explore hidden caves in Chiang Dao, taste tea at Mae Salong's hilltop plantations, discover the border culture of Mae Ai, and wind through the legendary Mae Hong Son loop — all in a private 4x4 with your Hebrew-speaking guide.",
    descriptionHe:
      "הרפתקת שטח בת 3 ימים בלתי נשכחת דרך ההרים של צפון תאילנד. חקרו מערות נסתרות בצ'יאנג דאו, טעמו תה במטעי מאה סאלונג, גלו את תרבות הגבול במאה אי, וסעו דרך לולאת מאה הונג סון האגדית — הכל ברכב 4x4 פרטי עם מדריך דובר עברית.",
    ...
    itinerary: [
      ...
      {
        day: 2,
        title: "Mae Salong Tea Plantations & Mae Ai Border",
        titleHe: "מטעי תה מאה סאלונג וגבול מאה אי",
        description:
      ...
      {
        day: 3,
        title: "Mae Hong Son Loop & Return to Chiang Mai",
        titleHe: "לולאת מאה הונג סון וחזרה לצ'יאנג מאי",
        description:
          "The legendary Mae Hong Son loop — one of Thailand's most scenic drives. Wind through 1,864 curves past mountain peaks, Karen villages, and jungle valleys. Stop at Pai for lunch and explore its artsy town center. Return to Chiang Mai via the mountain highway with breathtaking sunset views.",
        descriptionHe:
          "לולאת מאה הונג סון האגדית — אחת הנסיעות הציוריות ביותר בתאילנד. נסיעה דרך 1,864 פניות ליד פסגות הרים, כפרי קארן ועמקי ג'ונגל. עצירה בפאי לארוחת צהריים וחקירת מרכז העיירה האמנותי. חזרה לצ'יאנג מאי דרך כביש ההרים עם נוף שקיעה עוצר נשימה.",
        image: "/images/optimized/valley_panorama.jpg",
        highlights: [
          "1,864 curves scenic drive",
          "Karen hill tribe villages",
          "Pai town exploration",
          "Mountain sunset views",
        ],
        highlightsHe: [
          "נסיעה ציורית של 1,864 פניות",
          "כפרי שבט קארן",
          "חקירת עיירת פאי",
          "נוף שקיעה מההרים",
        ],
