...
import { ChevronLeft, ChevronRight, Users, MapPin, Calendar as CalendarIcon } from 'lucide-react';
...
export function BookingCalendar({ bookings, onBookingClick }: BookingCalendarProps) {
  ...
  const getBookingsForDate = (date: Date): Booking[] => {
    ...
    return bookings.filter(booking => {
      ...
      const departure = new Date(booking.departureDate).toISOString().split('T')[0];
    ...
    <Card className="w-full">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-7 gap-1">
          {calendarDays.map(({ date, isCurrentMonth, bookings: dayBookings }, index) => (
            <div
              key={index}
              className={`
        ...
        <DialogContent className="max-w-md">
          ...
          {selectedBooking && (
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-lg">{selectedBooking.contactName}</h4>
                <p className="text-sm text-muted-foreground">{selectedBooking.contactEmail}</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-medium">{formatDate(selectedBooking.arrivalDate)}</p>
                </div>
                <div>
